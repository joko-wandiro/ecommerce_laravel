            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <?php
                        $url_login = action(config('app.frontend_namespace') . 'CustomerController@login');
                        $url_account = action(config('app.frontend_namespace') . 'CustomerController@index');
                        $url = $url_login;
                        $url_text = "Login";
                        if (session('id')) {
                            $url = $url_account;
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="<?php echo $url; ?>"><?php echo $url_text; ?></a>
                            </li>
                        </ul>
                    </div>
                </nav>
