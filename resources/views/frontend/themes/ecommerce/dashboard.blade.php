        ...
        <div class="row">
            <div class="col-12">
                ...
                <ul id="order-steps" class="xrow">
                    <li class="com-3 active"><a href="<?php echo $url_dashboard; ?>">Dashboard</a></li>
                    <li class="com-3"><a href="<?php echo $url_order_history; ?>">Order History</a></li>
                ...
                <div id="welcome">
                    <div class="row">
                        <div class="col-12">
                            <div id="title">Welcome <?php echo session('name'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
