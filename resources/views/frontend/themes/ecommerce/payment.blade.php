        ...
        <div class="row">
            <div class="col-12">
                ...
                <ul id="order-steps" class="xrow">
                    <li class="com-6 active"><a href="<?php echo $url_cart; ?>">cart</a></li>
                    <li class="com-6 active"><a href="<?php echo $url_payment; ?>">payment</a></li>
                </ul>
                            ...
                            <div id="section-left">
                                ...
                                <div class="order-info">
                                    ...
                                    <div class="form-group">
                                        <textarea name="shipping_address" cols="2" class="form-control" placeholder="Address"></textarea>
                                    </div>                                    
                                </div>
